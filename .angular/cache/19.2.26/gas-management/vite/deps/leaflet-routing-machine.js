        ...
        module.exports = L2.Class.extend({
          ...
          _keyPressed: function(e) {
            ...
            if (this._autocomplete && document.activeElement === this._elem) {
              ...
              this._timer = setTimeout(L2.Util.bind(function() {
        ...
        module.exports = Itinerary.extend({
          ...
          _updateLines: function(routes) {
            ...
            if (routes.alternatives) routes.alternatives.forEach(function(alt, i) {
              this._alternatives[i] = this.options.routeLine(alt, L2.extend({
                isAlternative: true
              }, this.options.altLineOptions || this.options.lineOptions));
              this._alternatives[i].addTo(this._map);
              this._hookAltEvents(this._alternatives[i]);
            }, this);
            this._line = this.options.routeLine(routes.route, L2.extend({
              addWaypoints,
        ...
        module.exports = L2.Class.extend({
          ...
          formatInstruction: function(instr, i) {
            if (instr.text === void 0) {
              return this.capitalize(L2.Util.template(this._getInstructionTemplate(instr, i), L2.extend({}, instr, {
        ...
        module.exports = L2.Class.extend({
          ...
          options: {
            ...
            geocoderPlaceholder: function(i, numberWaypoints, geocoderElement) {
              ...
              return i === 0 ? l.startPlaceholder : i < numberWaypoints - 1 ? L2.Util.template(l.viaPlaceholder, {
                viaNumber: i
              }) : l.endPlaceholder;
            },
        ...
        module.exports = L2.Control.extend({
          ...
          _addRowListeners: function(row, coordinate) {
            L2.DomEvent.addListener(row, "mouseover", function() {
              this._marker = L2.circleMarker(coordinate, this.options.pointMarkerStyle).addTo(this._map);
            }, this);
        ...
        module.exports = L2.Class.extend({
          ...
          _toWaypoints: function(inputWaypoints, vias) {
            ...
            for (i = 0; i < vias.length; i++) {
              ...
              wps.push(new Waypoint(L2.latLng(viaLoc[1], viaLoc[0]), inputWaypoints[i].name, inputWaypoints[i].options));
            }
            return wps;
          },
        ...
        module.exports = (L2.Layer || L2.Class).extend({
          ...
          _dragNewWaypoint: function(newWpIndex, initialLatLng) {
            ...
            for (i = 0; i < this.options.dragStyles.length; i++) {
              lines.push(L2.polyline([prevWp.latLng, initialLatLng, nextWp.latLng], this.options.dragStyles[i]).addTo(this._map));
            }
            if (draggingEnabled) {
              this._map.dragging.disable();
            }
